...
<?php include_once './layout/navbar.php'; ?>
    ...
    <div class="container card my-3 w-50 shadow py-2">
        <h2 class="text-center mb-4">Book Availablity</h2>
    ...
    <p id="slot_result"></p>
    <button type="button" id="searchbtn" class="btn btn-primary" onclick="window.location.href='Searchresult.php';">Search</button>
    <button class="btn btn-danger" onclick="cancle()">Back</button>
</div>
